<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMRcambio.aspx.cs" Inherits="ProyectoUDI.Frontal.FMRcambio" %>
...
<body>
    <main>
        <header>
            <h1>Cambio de horario por aula</h1>
        </header>
        <form id="Cambio" runat="server">
            <div>
                <FONT COLOR="black">Selecion de AULA</font>
               ...
               <FONT COLOR="black">Horario</font>
                <asp:DropDownList id="HorarioList1"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="Selection_Change"
                    runat="server">
                ...
                <p><FONT COLOR="red">Ingrese aqui los datos a cambiar</font></p>

                <FONT COLOR="black"> Dia nuevo</font>
                    <asp:DropDownList id="DiaNuevoList1"
                    AutoPostBack="True"
                    OnSelectedIndexChanged="Selection_Change"
                    runat="server">
                ...
                <FONT COLOR="black">Horario inicio</font>
                ...
                <asp:Table runat ="server">
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell> <asp:TextBox runat = "server"  ID ="MaT"></asp:TextBox></asp:TableCell>
                ...
                <div>
                <asp:Button ID="Cambiar" runat="server" Text="Cambiar" OnClick="Cambiar_click" Width="63px"/>
