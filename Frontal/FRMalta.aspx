<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRMalta.aspx.cs" Inherits="ProyectoUDI.Frontal.FRMalta" %>
...
<body>
    <main>
        <header>
            <h1>Alta de horario</h1>
        </header>
        <form id="Alta" runat="server">
            <div>
                ...
                <div>
                <asp:Button ID="Guardar" runat="server" Text="Guardar" OnClick="Guardar_Click" Width="63px"/>
